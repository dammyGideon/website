      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header" style="background-color:#48887b">
            <h3 class="card-title" style="color:white">Blog Category</h3>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
               ...
               <tr>
                ...
                <td>
                    <a href="/edit_admin/{{ $category->id}}"
                      class="btn"style="background-color:#48887b;color:floralwhite">
                      Edit
                    </a>
                    <a href="/delete_blog_category/{{ $category->id}}" class="btn
                      btn-danger
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST"enctype="multipart/form-data" action="{{ asset('blog_category') }}">
            @csrf
